...
# Average CV score on the training set was: 0.8824152338624456
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=25.0, dual=False, epsilon=0.001, loss="squared_epsilon_insensitive", tol=0.01)),
